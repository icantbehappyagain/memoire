...
<section id="hero"> 
 <div class="container">
        <div id="slide">
            ...
            <div class="item" style="background-image: url(pics/2.jpg);">
                <div class="content">
                    <div class="name">LUNDEV</div>
                    <div class="des">Tinh ru anh di chay pho, chua kip chay pho thi anhchay mat tieu</div>
...
<?php                 
  ...
  ?>          
    ...
    <div id="banr">
        <style> #banr{  background-image: url(pics/banner.jpg);
          width: 100%;
          background-size: cover;
        }</style>
    <a href="produits.php">   <button class="btn">Voir plus de produits >></button></a>
    </div>
</section>
